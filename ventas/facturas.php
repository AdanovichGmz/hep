...
if (!$logged){
   header('Location:../index.php');
      ...
      $t=(isset($_SESSION['tienda']))?$_SESSION['tienda']:'';
        ...
        $query3="SELECT * FROM solicitud_factura limit  $start , $limit";
    
        $query2="SELECT * FROM solicitud_factura";
...
<div class="tablespace">
  ...
  <tr>
    ...
    <th><strong>Delegacion</strong></th>
    <th><strong>Estado</strong></th>
    <th><strong>Telefono</strong></th>
    <th><strong>email</strong></th>
    <th><strong>Fecha</strong></th>
    <th><strong>Archivo XML</strong></th>
  ...
  <tr>
    <td><?php echo $row['recibo'];?></td>
                        ...
                        <td><?=(!empty($row['archivo_xml']))? '<a class="xmlbutton" download href="../files/'.$row['archivo_xml'].'">XML</a>' : '--' ?></td>
                        <td><?=(!empty($row['archivo_pdf']))? '<a class="pdfbutton" download href="../files/'.$row['archivo_pdf'].'">PDF</a>' : '--' ?></td>
