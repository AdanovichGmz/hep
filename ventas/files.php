...
if (!$logged){
   header('Location:../index.php');
      ...
      $t=(isset($_SESSION['tienda']))?$_SESSION['tienda']:'';
        ...
        $query3="SELECT * FROM archivos limit  $start , $limit";
...
<div class="tablespace">
  ...
  <tr>
                        ...
                        <td > <a class="filebutton" href="http://henpapel.com/archivos/<?php echo $row['archivo'];?>" target="blank">DESCARGAR</a> </td>
...
$(document).on('keyup', '#searcher', function () {
  var parameter=$(this).val();
   ...
   $.ajax({  
           type:"POST",
           url:"pagesSearch.php",   
          data:{param:parameter,page:'files'},  
          success:function(data){ 
           $('#inv-body').html(data);
          }  
  });
