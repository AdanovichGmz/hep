...
if (!$logged){
   header('Location:../index.php');
      ...
      $t=(isset($_SESSION['tienda']))?$_SESSION['tienda']:'';
        ...
        $query3="SELECT * FROM movimientos WHERE tienda=$t limit  $start , $limit";
    
        $query2="SELECT * FROM movimientos WHERE tienda=$t";
...
$(document).on('keyup', '#searcher', function () {
  var parameter=$(this).val();
   ...
   $.ajax({  
           type:"POST",
           url:"pagesSearch.php",   
          data:{param:parameter,page:'moves'},  
          success:function(data){ 
           $('#inv-body').html(data);
          }  
  });
